...
begin
  if to_regclass('public.orders') is not null then
    ...
    alter table public.orders add column if not exists last_status_email_sent_at timestamptz;
    alter table public.orders add column if not exists last_status_email_status text;
  end if;
end $$;
